...
function main(){
  ...
  if(h.has("weekend")){
    console.log("weekend mevcut")
  }
  if(h.has("work")){
    console.log("work mevcut")
  }

  if(h.has("work") && h.has("weekend")){
    console.log("work ve weekend mevcut")
  }

  //2. Soru

  // let input = "istenilen değer"  burayı değiştirebilirsiniz.
